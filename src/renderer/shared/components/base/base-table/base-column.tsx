...
export interface IBaseColumn<T, U extends BaseLookupResult> {
  getClientSortedColumn(getCellData: CellLookup<T, U>, sortColumn: ClientSortCallback<T>): JSX.Element;
  getServerSortedColumn(getCellData: CellLookup<T, U>, sortColumn: ServerSortCallback): JSX.Element;
}
...
export abstract class BaseColumn<T, U extends BaseLookupResult> implements IBaseColumn<T, U> {
  ...
  public getClientSortedColumn(getCellData: CellLookup<T, U>, sortColumn: ClientSortCallback<T>): JSX.Element {
  ...
  public getServerSortedColumn(getCellData: CellLookup<T, U>, sortColumn: ServerSortCallback): JSX.Element {
